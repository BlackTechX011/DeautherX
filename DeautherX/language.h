...
const char CLI_deautherx[] PROGMEM = "deautherx";            // DeautherX, DeautherXs
...
const char CLI_HELP_deautherx[] PROGMEM = "deautherx";
...
const char CLI_HELP_FOOTER[] PROGMEM = "========================================================================\r\nfor more information please visit github.com/BlackTechX011/DeautherX\r\n========================================================================";
...
const char CLI_deautherx_OUTPUT[] PROGMEM = " |||||||||||| |||||||||||       ///\\\       |||        ||| ||||||||||||||| |||      ||| |||||||||| ||||||||| \\\\       ////  \r\n"
                                            " ||||     ||| |||              ///  \\\      |||        |||       |||       |||      ||| |||        |||   |||  \\\\     ////   \r\n"
                                            " ||||     ||| |||             ///    \\\     |||        |||       |||       |||      ||| |||        |||   |||   \\\\   ////    \r\n"
                                            " ||||     ||| |||||||||||    //////\\\\\\    |||        |||       |||       |||||||||||| |||||||||| |||\\\|||    \\\\ ////     \r\n"
                                            " ||||     ||| |||           ///        \\\   |||        |||       |||       |||      ||| |||        ||| \\\      //// \\\\     \r\n"
...
const char CLI_INFO_SOFTWARE[] PROGMEM = "DeautherX ";
const char CLI_INFO_COPYRIGHT[] PROGMEM = "2023 (c) BlackTechX";
const char CLI_INFO_LICENSE[] PROGMEM = "This software is licensed under the MIT License.";
const char CLI_INFO_ADDON[] PROGMEM = "For more information please visit github.com/BlackTechX011/DeautherX";
...
// MENU UTAMA
const char D_SCAN[] PROGMEM = "SCAN";
const char D_SHOW[] PROGMEM = "SHOW";
const char D_ATTACK[] PROGMEM = "ATTACK";
...
const char D_SCAN_ST[] PROGMEM = "SCAN ST";
...
// MENU DAFTAR SSID
const char D_CLONE_APS[] PROGMEM = "CLON APs";
const char D_RANDOM_MODE[] PROGMEM = "RENDOM MODE";
