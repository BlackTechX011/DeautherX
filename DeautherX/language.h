...
const char CLI_deautherx[] PROGMEM = "deautherx/s";                // deautherx, deautherxs
...
const char CLI_INFO_ADDON[] PROGMEM = "For more information please visit https://github.com/BlackTechX011/DeautherX";
...
const char D_PACKET_MONITOR[] PROGMEM = "PACKET MONITOR";
const char D_MORE[] PROGMEM = "MORE";
...
const char W_DEFAULT_LANG[] PROGMEM = "/lang/en.lang";
